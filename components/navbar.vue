	...
	<div class="main">
		<div class="logo">
			<a
				...
				><v-avatar size="70"> <nuxt-img src="logo2.png" /> </v-avatar>
			</a>
		</div>
		<div>
			<ul>
				...
				<div
					...
					id="loggedIn"
					class="tw-flex tw-flex-row tw-gap-2 tw-mr-5"
				>
					<li>
						<v-icon
				...
				>
					<li>
						<nuxt-link to="/login">
							<button
								class="tw-p-2 tw-rounded-md tw-text-white tw-font-semibold tw-text-base"
							>
								Login
							</button>
						</nuxt-link>
